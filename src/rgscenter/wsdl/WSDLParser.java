...
public class WSDLParser {
	...
	protected Vector createSchemaFromTypes(Definition wsdlDefinition) {
		...
		System.out
				.println("开始从Types中产生Schema,Definition下types元素的Schema元素个数可以多个,传进来的参数是一个Definition对象:");
	...
	private ServiceInfo populateComponent(ServiceInfo component, Service service) {
		...
		component.setTargetnamespace(namespace);//将目标命名空间赋值给ServiceInfo component对象
